<?php
/**
 * Template Name: MediaCathysArticlesChild
 *
 * @package WordPress
          ...
          <?php if ( get_the_content() !== '' ) { ?>
            <div class="page-content" class="entry clr">
              ...
              <div class="right-container">
                ...
                <!--
                <div class="menu">
                  <?php echo '<h3><a href="'.get_permalink($post).'">'.get_the_title($post).'</a></h3>'; ?>
                ...
                <div class="menu">
                  <?php echo '<h3><a href="'.get_permalink($post->post_parent->post_parent->post_parent).'">'.get_the_title($post->post_parent->post_parent->post_parent).'</a></h3>'; ?>
                  <ul>
                ...
                <div class="menu">
                  <?php echo '<h3><a href="'.get_permalink($post->post_parent->post_parent).'">'.get_the_title($post->post_parent->post_parent).'</a></h3>'; ?>
                  <ul>
                    <?php echo wp_list_pages('title_li=&child_of='.$post->post_parent->post_parent.'&echo=0'); ?>
                  </ul>
                </div>
